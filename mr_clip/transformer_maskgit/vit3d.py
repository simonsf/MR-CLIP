...
# vit - 3d ViT with factorized spatial and temporal attention made into an vqgan-vae autoencoder
...
class MRViT(nn.Module):
    def __init__(
        ...
        *,
        ...
        # print('*** check patch size:', patch_height, patch_width)
        ...
        # print('*** check patch size again:', patch_height, patch_width, temporal_patch_size)
    ...
    def forward(
        ...
        shape = tokens.shape
        *_, h, w, _ = shape
        # print('*** check image tokens size:', shape)
